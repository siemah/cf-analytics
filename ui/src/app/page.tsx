      ...
      <div className="flex gap-6 items-center justify-center flex-wrap">
        ...
        <div className="flex-1 min-w-fit bg-white rounded-3xl border py-8 px-6 w-3/6">
          ...
          <div>
            ...
            <h1 className="font-semibold text-xl text-gray-700">{globalStats?.country}</h1>
          </div>
        </div>
      </div>
              ...
              <div>
                {
                  popularPaths?.map((path: Record<string, string>, index: number) => (
                    ...
                    >
                      ...
                      <div className="text-gray-500">{path.total}</div>
                    </div>
                  ))
                }
              </div>
              ...
              <div>
                {
                  popularReferrers?.map((referrer: Record<string, string>, index: number) => (
                    ...
                    >
                      ...
                      <div className="text-gray-500">{referrer.total}</div>
                    </div>
                  ))
                }
              </div>
