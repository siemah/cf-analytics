...
export const metadata = {
  title: 'Dayen analytics based on cloudflare workers',
  description: 'Dayen analytics will collecte some details about visitors of youe app without tracking them',
}
